...
#: Endpoints polled on a timer by machines, not people. The ops agent's reports,
#: traced when it sent one every five seconds, were 95% of everything Jaeger held.
